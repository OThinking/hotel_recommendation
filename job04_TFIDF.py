...
print(Tfidf_matrix) # 출력값: (0, 11417) 0.04512411948261555 ... (1328, 21318)	0.06002166728989851
# (0, 11417) 0.04512411948261555는 행렬의 첫 번째 문서(0번 행)와 11417번 단어의 TF-IDF 점수가 0.04512411948261555라는 것을 의미
print(Tfidf_matrix.shape) # 출력값: (1329, 28150)
